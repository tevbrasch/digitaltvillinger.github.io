...
### Relaterte krav:  
[5.1 sanntidslevering av store data](../krav/5.1-sanntidslevering-av-store-data), 5.2 Dynamiske sensor data, 5.3 Lett API grensesnitt, 5.4 Sanntidsdata, 5.5 3D data, 5.7 Linkability, 5.8 Authoritative data, 5.9 4D data
